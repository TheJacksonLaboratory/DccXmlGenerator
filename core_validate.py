...
def updateAssayWithFailReason(expName,assayBarcode,failreason,failcomments):
    ...
    "IMPC_BWT_001_001_QC": "Above upper limit of quantitation",
    "IMPC_BWT_002_001": "-",
    "JAX_ASSAY_ASSAYFAILREASON": "{0}",
    "JAX_ASSAY_ASSAYFAILCOMMENTS": "{1}",
    "IMPC_BWT_005_001": "EM732"
    }""".format(failreason,failcomments,assayBarcode)
    ...
    result = requests.put(query, data=put_data, auth=my_auth,headers = {"Prefer": "odata.maxpagesize=5000"})  
    # Did it work? Chekc for code 200
    return 200
    
def updateExperimentStatus(expBarcode,status,comments):
    pass
